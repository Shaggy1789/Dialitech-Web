<template>
  <div class="register-form">
    <h2 class="form-title">Register as Patient</h2>
    ...
    <div class="fields-grid">
      <div class="field">
        ...
        <input class="field-input" placeholder="Jane" readonly />
      </div>
      <div class="field">
        <label class="field-label">Last Name</label>
        <input class="field-input" placeholder="Smith" readonly />
      </div>
      <div class="field">
        <label class="field-label">Email</label>
        <input class="field-input" type="email" placeholder="jane@example.com" readonly />
      </div>
      <div class="field">
      ...
      <div class="field">
        <label class="field-label">Medical Record #</label>
        <input class="field-input" placeholder="MRN-2026-00000" readonly />
      </div>
      <div class="field">
