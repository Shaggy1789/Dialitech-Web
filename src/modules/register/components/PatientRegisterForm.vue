  ...
  <div class="register-form">
    ...
    <div class="fields-grid">
      <div class="field">
        ...
        <input v-model="form.firstName" class="field-input" placeholder="Jane" />
      </div>
      <div class="field">
        <label class="field-label">Last Name</label>
        <input v-model="form.lastName" class="field-input" placeholder="Smith" />
      </div>
      <div class="field">
      ...
      <div class="field">
        ...
        <input v-model="form.medicalRecord" class="field-input" placeholder="MRN-2026-00000" />
      </div>
      <div class="field">
