  ...
  <div class="forgot-page">
    <div class="forgot-left">
      <div class="left-content">
        ...
        <h2 class="left-title">Verify Recovery<br />Code</h2>
        <p class="left-desc">Enter the verification code sent to your email or phone to continue with the password reset process.</p>
      </div>
    </div>
    ...
    <div class="forgot-right">
      <div class="forgot-card">
        ...
        <h1 class="forgot-title">Verify Code</h1>
        <p class="forgot-subtitle">Enter the 6-digit code we sent to your email or phone.</p>
...
async function handleVerify() {
  ...
  try {
    await authService.verifyCode({ code: code.value });
    successMsg.value = 'Code verified successfully. Redirecting...';
    setTimeout(() => router.push('/reset-password'), 1500);
  } catch (err) {
    error.value = err.response?.data?.message || err.message || 'Invalid or expired code. Please try again.';
  } finally {
    loading.value = false;
  }
}
